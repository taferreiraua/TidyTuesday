...
subtitle = paste0("<span style='font-family:spectral;font-size:25pt;'>Proporção de sentimentos</span>", 
                  ...
                  "<span style='font-family:spectral;font-size:25pt;'> de acordo com a análise de mais de 100mil tweets em linguas africanas.<br></span>",
...
ggplot(data) +
  ...
  theme(
    ...
    strip.text = element_markdown(family='spectral', lineheight = .6, vjust=0),
    strip.clip = 'off',
